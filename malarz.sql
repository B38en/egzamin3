...
--
-- Host: 127.0.0.1
-- Czas generowania: 03 Lut 2021, 17:21
...
CREATE TABLE `farby` (
  `id_farby` int(100) NOT NULL,
  `kolor` varchar(100) DEFAULT NULL,
  `cena` int(255) DEFAULT NULL,
  `pojemnosc` int(255) DEFAULT NULL
...
CREATE TABLE `malowanie` (
  `id_pomieszczenia` int(255) NOT NULL,
  `id_sciany` int(255) NOT NULL,
  `id_farby` int(255) DEFAULT NULL,
  `liczba_puszek` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
ALTER TABLE `farby`
  MODIFY `id_farby` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
